---
name: n8n-sdlc-rollback-workflow
description: Restore a workflow to a previous version using n8n built-in version history. Use when a promotion causes issues, a push introduces a bug, or user says "rollback", "revert", "undo promotion", or "restore previous version".
---
...
- `n8n-sdlc-promote-workflow` - Rollback is the safety net for failed promotions
- `n8n-sdlc-push-workflow` - Rollback can undo a bad push
- `n8n-sdlc-validate-workflow` - Validate after rollback
