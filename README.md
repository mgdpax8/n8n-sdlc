> **Template users:** Replace this README with your own project README after setup.
...
**Version:** See [VERSION](n8n-sdlc/VERSION) | [Changelog](n8n-sdlc/CHANGELOG.md)
...
See [Team Onboarding](n8n-sdlc/docs/Team-Onboarding.md) for all options including manual setup.
...
|----------|-------------|
| [PRD](n8n-sdlc/docs/n8n-SDLC-PRD.md) | Product Requirements Document |
| [MCP Test Plan](n8n-sdlc/docs/MCP-Test-Plan.md) | MCP behavior tests and results |
