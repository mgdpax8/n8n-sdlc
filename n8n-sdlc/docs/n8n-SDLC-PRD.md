...
| Folder structure | Create agents/, tools/ directories; n8n-sdlc/config/ and n8n-sdlc/docs/ provided by framework | P1 |
...
| Automation | Cursor Skills (.cursor/skills/*/SKILL.md) |
...
│   └── skills/
│       ├── n8n-sdlc-getting-started/
│       │   └── SKILL.md
│       ├── n8n-sdlc-import-project/
│       │   └── SKILL.md
│       ├── n8n-sdlc-reserve-workflows/
│       │   └── SKILL.md
│       ├── n8n-sdlc-seed-dev/
│       │   └── SKILL.md
│       ├── n8n-sdlc-pull-workflow/
│       │   └── SKILL.md
│       ├── n8n-sdlc-push-workflow/
│       │   └── SKILL.md
│       ├── n8n-sdlc-promote-workflow/
│       │   └── SKILL.md
│       └── n8n-sdlc-validate-workflow/
│           └── SKILL.md
├── n8n-sdlc/
│   ├── config/
